  ...
  return (
    <div>
      ...
      <div className='container mx-auto px-3 py-16 lg:py-0 flex flex-col lg:flex-row gap-5 lg:gap-10'>
        ...
        <div>
          <h2 className='text-2xl lg:text-4xl font-bold text-white'>{data?.title || data?.name || 'Unknown Title'}</h2>
          <p className='text-neutral-400'>{data?.tagline || 'No tagline available'}</p>
